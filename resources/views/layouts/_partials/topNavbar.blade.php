                  ...
                  <div class="flex items-center justify-between w-full px-4 py-1 mx-auto flex-wrap-inherit">
                    <nav>
                      ...
                      <ol class="flex flex-wrap pt-1 mr-12 bg-transparent rounded-lg sm:mr-16">
                        ...
                        <li class="text-sm pl-2 capitalize leading-normal text-white before:float-left before:pr-2 before:text-white before:content-['/']" aria-current="page">{{ __("$page") }}</li>
                      </ol>
                    ...
                    <div class="flex items-center mt-2 grow sm:mt-0 sm:mr-6 md:mr-0 lg:flex lg:basis-auto">
                      ...
                      <ul class="flex flex-row justify-end pl-0 mb-0 list-none md-max:w-full"> 
                        ...
                        <li class="flex items-center px-4">
                            ...
                            <button id="dropdownNavbarLink" data-dropdown-toggle="dropdownNavbar" class="font-semibold text-sm transition duration-200 ease-in flex items-center justify-between w-full py-2  text-white rounded"> <i fixed-plugin-button-nav class="cursor-pointer fa fa-cog"></i>
                            </button>
                                      <!-- Dropdown menu -->
