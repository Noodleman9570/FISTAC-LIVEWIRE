        ...
        <div class="flex justify-between items-stary">
            <div class="flex-col items-center">
                <div class="flex items-center mb-1">
                    <h5 class="text-xl font-bold leading-none text-gray-900 dark:text-white me-1">Porcentaje de timbres vendidos</h5>
        ...
        window.addEventListener("load", function() {
            const getChartOptions = () => {
                return {
                    ...
                    labels: ["Principal", "Gobernación", "Zona educativa"],
                    dataLabels: {
                        enabled: true,
                        style: {
