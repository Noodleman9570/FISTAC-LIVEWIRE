          ...
          <div class="w-full max-w-full  md:flex-none">
            <div class="relative flex flex-col min-w-0 break-words bg-white border-0 border-transparent border-solid shadow-xl dark:bg-slate-850 dark:shadow-dark-xl rounded-2xl bg-clip-border">
              ...
              <div class="flex flex-row w-full justify-around">
                <div class="group  dark:hover:bg-[#374a6250] hover:bg-gray-200 w-full rounded-md transition ease-in duration-100">
                  <a href="{{ route('AsigTimElec.index') }}">
                    <div class="p-4 mx-6 mb-0 text-center border-b-0 border-b-solid rounded-t-2xl border-b-transparent">
                      <div class="w-16 h-16 group-hover:w-full text-center bg-center shadow-sm icon group-transition ease-in duration-100 bg-gradient-to-tl from-blue-500 to-violet-500 rounded-xl">
                ...
                <div class="w-full group dark:hover:bg-[#374a6250] hover:bg-gray-200 rounded-md transition ease-in duration-100">
                  <a href="{{ route('GenTimFis.index') }}">
                    ...
                    <div class="flex-auto p-4 pt-0 text-center">
                      ...
                      <hr class="h-px my-4 bg-transparent bg-gradient-to-r from-transparent via-black/40 to-transparent dark:bg-gradient-to-r dark:from-transparent dark:via-white dark:to-transparent" />
                      <span class="text-xs leading-tight dark:text-white dark:opacity-80">Imprimir</span>
                    </div>
                  </a>              
                </div>
              </div>
