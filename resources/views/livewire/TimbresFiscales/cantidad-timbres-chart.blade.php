<div>
    ...
    <div class=" w-full bg-white rounded-lg shadow dark:bg-[#111c44] p-4 md:p-6 h-98">
        <div class="flex justify-between py-8 mb-4 border-b border-gray-200 dark:border-gray-700">
            <div class="flex items-center">
                <div class="w-16 h-16 p-3 rounded-lg bg-gray-100 dark:bg-gray-700 flex items-center justify-center me-3">
                ...
                <div>
                    <h5 class="leading-none text-2xl font-bold text-gray-900 dark:text-white pb-1">1546</h5>
                    <p class="text-lg font-normal text-gray-500 dark:text-gray-400">Timbres vendidos esta semana</p>
                </div>
            </div>
            <div>
                <span
                    class="bg-green-100 text-xl text-green-800 font-medium inline-flex items-center px-2.5 py-1 rounded-md dark:bg-green-900 dark:text-green-300">
        ...
        <div id="column-chart" class="py-8"></div>
        <div class="grid grid-cols-1 items-center py-8 border-gray-200 border-t dark:border-gray-700 justify-between">
