...
<nav class="fixed inset-y-0 text-black z-30 dark:text-white bg-white dark:bg-[#1f2937] flex-wrap items-center justify-between block w-full p-0 my-4 overflow-y-auto antialiased  border-0 shadow-xl dark:shadow-none dark:bg-slate-850 max-w-64 ease-nav-brand z-990 xl:ml-6 rounded-2xl xl:left-0 " aria-expanded="false">
